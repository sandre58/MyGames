// -----------------------------------------------------------------------
// <copyright file="Connect4Board.cs" company="Stéphane ANDRE">
...
public class Connect4Board : Board<Connect4Piece>
{
    ...
    public Connect4Board(int rows = DefaultRows, int columns = DefaultColumns)
        : base(rows, columns) { }

    public Connect4Board(int rows, int columns, IDictionary<Connect4Piece, BoardCoordinates> pieces)
