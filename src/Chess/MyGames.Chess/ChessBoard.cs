// -----------------------------------------------------------------------
// <copyright file="ChessBoard.cs" company="Stéphane ANDRE">
...
public sealed class ChessBoard : Board<ChessPiece>
{
    ...
    public static ChessColor GetOpponentColor(ChessColor color) => color == ChessColor.White ? ChessColor.Black : ChessColor.White;
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1721:Property names should not match get methods", Justification = "Provide Pieces of specified color")]
    ...
    protected override Board<ChessPiece> NewInstance(IDictionary<ChessPiece, BoardCoordinates> pieces)
        => new ChessBoard(Whites.Clone(), Blacks.Clone(), (_, __) => pieces.ToDictionary(z => z.Key, z => (z.Value.Row, z.Value.Column)));
}
