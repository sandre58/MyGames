...
{
    public class ChessBoardPiecesCollection : IReadOnlyList<ChessPiece>, ISettable<ChessBoardPiecesCollection>, ICloneable<ChessBoardPiecesCollection>
    {
        ...
        public IEnumerable<ChessPiece> GetOriginalPieces() => _originalPieces.Cast<ChessPiece>().ToList();
