// -----------------------------------------------------------------------
// <copyright file="ChessGame.cs" company="Stéphane ANDRE">
...
public sealed class ChessGame(ChessBoard board, IChessPlayer whitePlayer, IChessPlayer blackPlayer, int currentPlayerIndex = 0) : BoardGame<ChessBoard, IChessPlayer, ChessPiece, IChessMove, ChessPlayedMove>(board, [whitePlayer, blackPlayer], currentPlayerIndex)
{
    ...
    public ChessGame(IChessPlayer whitePlayer, IChessPlayer blackPlayer)
        : this(new ChessBoard(), whitePlayer, blackPlayer) { }
    ...
    protected override IChessPlayer? ComputeWinner()
    ...
    protected override IChessMove NextMoveOfCurrentPlayer() => CurrentPlayer.NextMove(this);
