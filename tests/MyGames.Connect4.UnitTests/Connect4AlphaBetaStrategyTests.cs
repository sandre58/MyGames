// -----------------------------------------------------------------------
// <copyright file="Connect4AlphaBetaStrategyTests.cs" company="Stéphane ANDRE">
...
public class Connect4AlphaBetaStrategyTests
{
    ...
    public Connect4AlphaBetaStrategyTests()
    {
        ...
        _game = new Connect4Game([_player, new MockPlayer()]);
    }
    ...
    {
        // Arrange
        for (var i = 0; i < _game.Board.Columns.Count; i++)
        {
            for (var j = 0; j < _game.Board.Rows.Count; j++)
            {
